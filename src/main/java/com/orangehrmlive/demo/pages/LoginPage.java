...
import com.orangehrmlive.demo.customelisteners.CustomeListener;
...
public class LoginPage extends Utility {
    ...
    public void enterUserNameField(String Username) {
        ...
        CustomeListener.test.log(Status.PASS, "Enter Username" + Username);
    }

    public void enterPasswordField(String Password) {
        sendTextToElement(passwordField, Password);
        CustomeListener.test.log(Status.PASS, "Enter Password" + Password);
    }

    public void clickOnLoginBtn() {
        clickOnElement(loginBtn);
        CustomeListener.test.log(Status.PASS, "click on login button");
    }
